...
Set xml_obj = New MSXML2.XMLHTTP60
    ...
    repo_name = "VBA/"
    username = "cku-7220/"
    file_name = "test_VBA1.vb"
    access_token = "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"
    ...
    'Define the Payload.
    payload = "{""message"":""Upload VBA code to GitHUB"",""content"":"""
...
'Set VBProj = VBAEditor.VBProjects
Set VBProj = ActiveWorkbook.VBProject
